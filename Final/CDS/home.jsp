...
<head>
	<title>Road2Recovery : Home</title>
	<!--/tags -->
		...
		<div class="container">
			 <div class="header_left">
				<ul>
					...
					<li><i class="fa fa-envelope-o" aria-hidden="true"></i> <a href="mailto:customer.care@r2r.com">customer.care@r2r.com</a></li>
			...
			<div class="header_right">
				<ul class="forms_right">					
					<li><a href="<c:url value="donate" />"> Alcohol  </a> </li>
					<li><a href="message"> Drugs  </a> </li>
				</ul>
			</div>
				...
				<div class="container">
					...
					<span class="icon-bar"></span>
						...
						<a class="navbar-brand" href="home">
							<h1><span class="fa fa-stethoscope" aria-hidden="true"></span>Road2Recovery </h1>
						</a>
					</div>
					<!--/.navbar-header-->
			...
			<div class="item active">
				<div class="container">
					<div class="carousel-caption">
						<h3>Path to <span>Success</span></h3>
						<div class="header_left">
							<ul class="forms_right">
								<li><a href="appointment.html"> Alcohol  </a> </li>
							</ul>
						</div>
						<div class="header_right">
							<ul class="forms_right">								
								<li><a href="appointment.html"> Drugs  </a> </li>
							</ul>
						</div>										
						<p> Addiction is the only prison where the locks are on the inside.</p>						
						<h6>Join us to overcome one of the toughest battleship in your life against alcohol and drug abuse. </h6>
					</div>
				</div>
			</div> 		
			<div class="item item2">
				<div class="container">
					<div class="carousel-caption">						
						...
						<p>An over indulgence of anything can intoxicate.</p>
						<h6>Join us to overcome one of the toughest battleship in your life against alcohol and drug abuse. </h6>
					</div>
				</div>
			</div>
			<div class="item item3">
				<div class="container">
					<div class="carousel-caption">
						...
						<p>Join yourself on the path of recovery.</p>
						<h6>Join us to overcome one of the toughest battleship in your life against alcohol and drug abuse. </h6>
					</div>
				</div>
			</div>
			<div class="item item4">
				<div class="container">
					<div class="carousel-caption">						
						...
						<div class="header_left">
							<ul class="forms_right">
								<li class><a href="appointment.html"> Alcohol  </a> </li>
							</ul>
						</div>
						<div class="header_right">
							<ul class="forms_right">								
						...
						<p>Instead of giving a reason why you can't , give yourself a reason why you can.</p>
						<h6>Join us to overcome one of the toughest battleship in your life against alcohol and drug abuse. </h6>
					</div>
				</div>
			</div>
...
<!-- about-bottom -->
	...
	<h3 class="heading-agileinfo">Welcome To The World of Redefined Life!<span>Thanks for being a part of our Projects.</span></h3>
		<div class="container">
			...
			<div class="col-md-6">
				<div class="grid1">
					<h4 class="agileinfo-head">ALCOHOL</h4>
					<p class="post-title"><b>Are you an Alcoholic ??? </b></p></br>
					<ul><b>
						<li> * Dependence on alcohol develops over time.However, a person can suffer from alcohol poisoning on his or her first drinking occasion, depending on the consumption level. </li></br>
						<li> * Several million people engage in risky, binge drinking patterns that could lead to alcohol problems or persist a family history of alcoholism.	</li></br>
						<li> * Alcohol is the perfect solvent that dissolves  marriages,families and careers causing serious health complications and emotional instability. </li></br>
			...
			<!--div class="col-md-6">
				...
				<li> * 1 organ donor can save 8 lives and change the lives of more than 50 people.</li>
				<li> * Almost anyone can be an organ donor, regardless of age or medical history.</li>
			...
			<div class="col-md-6">
				<div class="grid1">
					<h4 class="agileinfo-head">DRUGS</h4>
					<p class="post-title"><b>Are you a Drug Addict?</b></p></br>
						<ul><b>
							<li> * In Canada, cocaine is the most common drug of injection users causing death due to overdoses.</li></br>
							<li> * Cocaine is a highly addictive drug that produces intense feelings of euphoria, power and confidence. All of these side effects make the risk of abuse very high for even the occasional cocaine user.</li></br>
							<li> * Toronto treatment centers report that cocaine is second only to alcohol as the most problematic substance requiring treatment.</li></br>
						<li class="post-title"><b>Book an appointment with a doc Now !!!</b></li></b>
						</ul>
				</div>
			</div>
							...
							<div class="carousel-inner">
									...
									<blockquote>
										<div class="test_grid">
											<div class="col-sm-3 text-center test_img">
												<img src="images/satish.jpg" alt=" " class="img-responsive" />

											</div>
											<div class="col-sm-9 test_img_info">
												<p>Today my life is honest and true. I don’t have nearly the material things I once did – but what I have today is a reflection in the mirror that I can look at and feel good about it.</p>
												<h6>Jack</h6>
											</div>
										</div>
									</blockquote>
								...
								<div class="item">
									<blockquote>
										<div class="test_grid">
											...
											<div class="col-sm-9 test_img_info">
												<p>I can say that "R2R" is the one that has given me the tools to make the most life changes.</p>
												<h6>Jane Wearne</h6>
											</div>
										</div>
									</blockquote>
								...
								<div class="item">
									<blockquote>
										<div class="test_grid">
											<div class="col-sm-3 text-center test_img">
												<img src="images/sudheer.jpg" alt=" " class="img-responsive" />
											</div>
											<div class="col-sm-9 test_img_info">
												<p> I feel free of alcohol’s grip at last.</p>
												<h6> Williams</h6>
											</div>
										</div>
									</blockquote>
								...
								<div class="item">
									<blockquote>
										<div class="test_grid">
											<div class="col-sm-3 text-center test_img">
												<img src="images/Sravan.jpg" alt=" " class="img-responsive" />
											</div>
											<div class="col-sm-9 test_img_info">
												<p>This is to tell you, oh struggling people out there, that I was where you are now. But I did the work suggested here, and progressed.</p>
												<h6>Ron</h6>
											</div>
										</div>
									</blockquote>
	...
	<div class="footer_top_agile_w3ls">
		<div class="container">
			<div class="col-md-4 footer_grid">
				<h3>About Us</h3>
				<p>At Road2Recovery we believe you can overcome the toughest battles of your life against alcohol and drug abuse.</p>				
			</div>
			...
			<div class="col-md-4 footer_grid ">
				...
				<div class="footer_grid_right">
					...
					<form action="#" method="post">
						<input type="email" id="emailadd" name="Email" placeholder="Email Address..." required="">
